    ...
    <div className='About-Component animated-element'>
        <div className='About-Container'>
          <Link to='/home'>
            ...
            <p>Actualmente no contamos con aplicación móvil, esperamos proximamente tenerla lista para todos nuestros usuarios, pero puedes acceder a nuestra página web en https://bait-one.vercel.app para explorar la amplia variedad de opciones gastronómicas disponibles en tu ciudad.</p>
