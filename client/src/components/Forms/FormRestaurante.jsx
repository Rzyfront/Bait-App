...
const FormRest = () => {
  ...
  const changeHandler = (event) => {
    ...
    setFormRest({ ...FormRest, [property]: value });
    validate(FormRest);
  };
    ...
    <form>
      ...
      <div>
        ...
        <input
          ...
          name="phone"
          pattern="[0-9]{10}"
          title="Ingrese un número de teléfono válido de 13 dígitos"
