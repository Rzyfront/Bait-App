    ...
    <h1>Crea un nuevo Local</h1>
      <form onSubmit={handleSubmit}>
         ...
         <label >Ubicacion: </label>  
           <select name="location" className="location" onChange={() => alert("Change")}>
          ...
          <label for = "imagen">Imagenes</label>
                ...
                name="imagen" 
                accept="image/*" 
                multiple value= {inputs.imagen} 
                onChange={handleChange} 
                required></input>
                 <hr />

          <label >Tipos de Comida: </label>  
           <select id= "category-select" multiple name="checkbox" className="checkbox" onChange={() => alert("Change")}>
            ...
            <hr />
                ...
                <label for="lunes"><input type="checkbox" multiple value= {inputs.schedule} 
                onChange={handleChange} id="lunes" name="dias"/>Lunes</label>
                <label for="martes"><input type="checkbox" id="martes" name="dias" value="martes"/>Martes</label>
                <label for="miercoles"><input type="checkbox" id="miercoles" name="dias" value="miercoles"/>Miércoles</label>
                <label for="jueves"><input type="checkbox" id="jueves" name="dias" value="jueves"/>Jueves</label>
                <label for="viernes"><input type="checkbox" id="viernes" name="dias" value="viernes"/>Viernes</label>
                <label for="sabado"><input type="checkbox" id="sabado" name="dias" value="sabado"/>Sabado</label>
                <label for="domingo"><input type="checkbox" id="domingo" name="dias" value="domingo"/>Domingo</label>
                <hr/> 
